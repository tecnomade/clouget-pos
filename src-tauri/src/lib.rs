...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ventas::aprender_placa_chofer,
            commands::ventas::sugerir_por_placa,
            commands::ventas::sugerir_por_chofer,
            ...
            // v2.5.44: módulo Contabilidad (agente de retención + ATS)
            ...
            restaurante::commands::rest_listar_abonos_holding_caja,
